...
export default function HabitsCard({ habit, className = '', onClick }: Props) {
  ...
  return habit ? (
    <div className={`${className} ht-interaction pt-2 pb-2 px-3 rounded-lg bg-green-50 outline-1 outline-offset-1 outline-green-200 flex flex-col gap-1`} onClick={() => { handleOnClick() }}>
